...
import { User, Promotion, Project, Group, Deliverable, DeliverableRule, DeliverableSubmission, Report, ReportSection, Defense, GradingGrid, GradingCriterion, Grade, CriterionGrade } from '../entities/Entities';
async function insertTestData() {
    try {
        ...
        try {
            ...
            const promotionRepository = queryRunner.manager.getRepository(Promotion);
            ...
            const deliverableRepository = queryRunner.manager.getRepository(Deliverable);
            ...
            const ruleRepository = queryRunner.manager.getRepository(DeliverableRule);
            ...
            const submissionRepository = queryRunner.manager.getRepository(DeliverableSubmission);
            ...
            const sectionRepository = queryRunner.manager.getRepository(ReportSection);
            ...
            const defenseRepository = queryRunner.manager.getRepository(Defense);
            ...
            const gridRepository = queryRunner.manager.getRepository(GradingGrid);
            ...
            const criterionRepository = queryRunner.manager.getRepository(GradingCriterion);
            ...
            const gradeRepository = queryRunner.manager.getRepository(Grade);
            ...
            const criterionGradeRepository = queryRunner.manager.getRepository(CriterionGrade);
