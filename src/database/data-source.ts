...
import { CriterionGrade, Defense, Deliverable, DeliverableRule, DeliverableSubmission, Grade, GradingCriterion, GradingGrid, Group, Project, Report, Promotion, ReportSection, User, SubmissionFingerprint, SimilarityResult } from "../entities/Entities";
dotenv.config();
